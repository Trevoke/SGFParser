...
- handle merging of games together (they are stored in the same tree and become a variation
    when they first become distinguishable from all the other games in the tree).
