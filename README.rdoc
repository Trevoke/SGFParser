...
- let the indenter become an executable that takes input sgf and output sgf as arguments.
- implement checking for validity of SGF.
- implement a list of errors/warnings that happened when parsing.
